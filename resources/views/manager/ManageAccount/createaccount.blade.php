                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" >
                        <div class="tab-pane container-fluid active" id="addsingleuser">
                            ...
                            <form action="{{ route('manager.createaccount')}}" method="POST" >
                             @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="role" value="{{old('role')}}" class="form-control" style="width: 100%;" id="role-select" required>
                                                ...
                                                <option value="credit_controller">Credit Controller</option>
                                                <option value="saving_controller">Saving Controller</option>
                                            </select>
